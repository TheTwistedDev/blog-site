import { Logo, FlyoutMenu, MobileMenu } from '../components/index'
    ...
    <header className="border-b border-gray-100 dark:border-gray-700">
        <div className="container flex items-center justify-between px-4 py-4 mx-auto sm:px-6">
            ...
            {!loading ? (
              <div>
                {!session?.user ? (
                  <button type="button" onClick={() => signIn()} className="px-6 py-2 text-lg text-white bg-blue-600 border-2 border-blue-600 rounded-md hover:bg-blue-700 hover:border-blue-700 sm:text-xl focus:outline-none focus:ring-4 focus:ring-blue-600 focus:ring-opacity-50 whitespace-nowrap"> Sign In </button>
                ) : (
