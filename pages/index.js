    ...
    <div>
        <Layout>
          ...
          <section className="flex flex-col items-center justify-center mt-12 space-y-10 sm:mt-24 md:mt-32">
             ...
             <button type="button" onClick={() => signIn('google')} className="px-6 py-3 text-lg text-white bg-blue-600 border-2 border-blue-600 rounded-md hover:bg-blue-700 hover:border-blue-700 sm:text-xl focus:outline-none focus:ring-4 focus:ring-blue-600 focus:ring-opacity-50 whitespace-nowrap">
